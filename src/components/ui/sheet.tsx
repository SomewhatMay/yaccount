...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // Motion budget §12.5: the scrim is a value ticking over (--dur-2), the
        // surface itself arrives on --dur-3 below. One curve for both.
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50 bg-black/10 duration-[var(--dur-2)] ease-[var(--ease-register)] supports-backdrop-filter:backdrop-blur-xs",
        className,
      )}
      {...props}
    />
